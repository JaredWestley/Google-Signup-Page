import './App.css';
import { InputAdornment, TextField, Box, Button, Checkbox } from '@mui/material';
    ...
    <div 
      ...
      <div 
        ...
        <div style={{textAlign: "left", width:"350px"}}>
          ...
          <Box component="form" noValidate autoComplete="off" style={{marginTop: "40px"}}>
            <TextField 
              id="outlined-basic" 
              label="Username" 
              variant="outlined" 
          ...
          <div 
            style={{
              ...
              marginTop:"40px"}}>
                ...
                <Button 
                  variant="contained"
                    style={{textTransform:"none", fontWeight: 500, marginLeft:"155px", width:"79px"}}>
                      Next
                </Button>
          </div>
        </div>
